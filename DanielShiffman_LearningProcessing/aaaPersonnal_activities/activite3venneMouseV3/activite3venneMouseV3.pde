...
int offset = 50;
byte insideRange = 0;
/* using these values to determine where is mouse:
  1 is inside c1
  2 is inside c2
  4 is insode c3
*/
...
void setup() {
 ...
 drawCrosshair(centerWindowX, centerWindowY, 0);
...
void draw() {
 ...
 switch(insideRange) {
  case 1:
   drawC1(true);  // colors c1
   drawC2(false); // clears c2
   drawC3(false); // clears c3
   break;
